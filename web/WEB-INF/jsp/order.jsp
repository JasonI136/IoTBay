                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center">
                            <c:choose>
                                ...
                                <c:when test="${order.orderStatus eq 'CANCELLED'}">
                                    ...
                                    <div class="progress" style="height: 10px; width: 200%">
                                        <div class="progress-bar bg-warning" role="progressbar"
                                            style="width: 0; margin-right: -100%" aria-valuenow="0" aria-valuemin="0"
                                            aria-valuemax="100">
                                        </div>
                                </c:when>

                                <c:otherwise>
                                    <h1 class="ltext-105 txt-center mb-4" style="font-size: 30px !important;">There
                                ...
                                <div class="wrap-table-shopping-cart">
                                    <table class="table-shopping-cart">
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-4">${product.getQuantity()}</td>
